...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn(
        "bg-oklch(1 0 0) group/calendar p-3 [--cell-size:2rem] in-data-[slot=card-content]:bg-transparent in-data-[slot=popover-content]:bg-transparent dark:bg-oklch(0.145 0 0)",
      ...
      classNames={{
        ...
        range_end: cn(
          "bg-oklch(0.97 0 0) rounded-r-md dark:bg-oklch(0.269 0 0)",
